//Gnotifications = Global Notifications
...
let obj = {
    fields: {
        ...
        seen_users: { type: "set", typeDef: "<text>" },
        receive_users: { type: "set", typeDef: "<text>" },
        is_delete: { type: "set", typeDef: "<text>", default: [] }

    },
    key: ["notification_id", "order_id"],
    clustering_order: {"order_id" : "desc"},
    indexes: ["type"],
