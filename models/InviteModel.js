...
let obj = {
	fields: {
			...
			invite_to: { type: "uuid" },
			email_to: { type: "text", default: null },
            invite_by: { type: "uuid", default: null },
            status: { type: "text", default: "Invited" },
            invite_time: { type: "timestamp", default: { "$db_function": "toTimestamp(now())" } }
    },
	key: ["conversation_id", "invite_to"],
	indexes: ["email_to", "status"],
