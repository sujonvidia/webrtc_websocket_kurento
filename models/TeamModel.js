...
let obj = {
	fields: {
		...
		company_id: { type: "timeuuid", default: "NOT NULL" },
		team_title: { type: "text", default: "NOT NULL" },
		team_admin: { type: "set", typeDef: "<text>", default: null },
		participants: { type: "set", typeDef: "<text>", default: null }
	},
	key: ["team_id"],
