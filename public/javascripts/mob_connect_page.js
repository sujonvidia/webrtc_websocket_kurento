...
function open_duedate_box(elm) {
    ...
    $("#task_manager").removeClass("decline_open").removeClass("request_open").removeClass("decline_review_open").removeClass('request_review_open');
    $('#marked_btn_sec').hide();
    if (type == "Decline") {
        ...
        $("#task_manager").addClass("decline_review_open");
        ...
        $("#task_manager").addClass("request_review_open");
        $('.buttonAction').removeAttr('disabled');
    }
